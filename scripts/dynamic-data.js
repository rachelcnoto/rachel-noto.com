...
YUI.add( 'squarespace-dynamic-data', function( Y ) {
  ...
  Y.Squarespace.DynamicData = function( params ) {
    ...
    var preCallback = ( params && params.preCallback ) || null;
    var postCallback = ( params && params.postCallback ) || null;
    var useHashes = ( params && params.useHashes ) || false;
    var autoOpenHash = ( params && params.autoOpenHash ) || false;
    var injectEl = ( params && params.injectEl ) || null;
    var minimumResolution = ( params && params.minimumResolution ) || null;
    var scrollToWrapperPreLoad = ( params && params.scrollToWrapperPreLoad ) || false;
    var appendData = ( params && params.appendData ) || null;
    var classes = {
    ...
    function fetch( e, simulate ) {
      ...
      var url = ( simulate ) || ( trigger && trigger.getAttribute( 'href' ) );
      var tempWrapper;
      var loadingWrapper;
    ...
    function sqsBlocks(callback) {
      ...
      // This event was added just for developers who want to execute
      // JavaScript on dynamic page loads. Please do not delete. You
      // can blame Kevin Foley for the crappy namespacing.
      Y.fire('avenue:dynamicPageReady');
